...
async function getFromStorage(moviesArray) {
    let movieHtml = ''
        ...
        myWatchlist.style.background = "black"
        ...
        if (!moviesFromLocalStorage.length) { 
            ...
            myWatchlist.style.background = "black"
            document.getElementById('empty').style.color = "yellow" 
    }
...
function removeFromWatchlist(movieId) {
    const removeMovie = moviesFromLocalStorage.findIndex(movie => movie.imdbID === movieId)
